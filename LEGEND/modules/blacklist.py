...
from LEGEND import dispatcher, LOGGER
...
It is used to stop certain triggers from being said in a group. Any time the trigger is mentioned, the message will immediately be deleted. you can also set penalty with it.
*NOTE*: It will not affect group admins.
