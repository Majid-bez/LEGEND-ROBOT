...
__help__ = """
Sometimes user use group cmnds whom they don't have any idea and making group messy for stopping such stupidity blue text cleaner is here..
It will remove cmnds messages which will use by users..
